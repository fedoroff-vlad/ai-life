 ...
 * {@code pendingAction.flow} discriminator: {@code receipt-confirm} ({@link ReceiptParser#resume}) or
 * {@code sharing-confirm} (ADR-0002 item 8 DS-N — the reusable {@link SharingConfirm} confirm loop,
