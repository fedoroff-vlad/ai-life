 ...
 * passthrough to run a vision caption over a stored image. The wardrobe-catalogue flow uses this
 * to turn a garment photo into a structured description — the vision call lives once, in the
 * capability-MCP, so the stylist reuses it rather than embedding the {@code vision} channel here
 * (same as finance's receipt-parser, MP-c).
 *
