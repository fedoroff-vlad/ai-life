...
**Migrating the remaining 6, one PR each. Done: `docs-agent` ✅ (2026-08-17)** — its `FIND_CUES` heuristic
replaced by `DocsIntentRouter` over the shared router; two docs carve-outs preserved: the photo-ingest
