...
## Now
- **No active owner-priority slice.** The owner's priority queue (post-second-brain items 1–4) is fully shipped: resurfacing, ambient capture, platform migration, build/CI perf, and now **finance year-analysis report + chart-render — [#291](https://github.com/fedoroff-vlad/ai-life/issues/291) ✅ COMPLETE + [#292](https://github.com/fedoroff-vlad/ai-life/issues/292) ✅** (chart-render capability, PR1 monthly-report chart embed, PR2 `YearReporter`, PR3 `CategoryManager` — all merged, see [HISTORY.md](HISTORY.md)). Next work is from the backlog below — **coach-agent [#289](https://github.com/fedoroff-vlad/ai-life/issues/289) is the flagged next (spec-first)**; confirm the pick with the owner before starting.
